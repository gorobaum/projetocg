...
\subsection{Rendering the white cube}
	...
	Because there were many variables involved – geometry, materials, and image based lighting coefficient - we were not able to reproduce the shading the cubes should have had. It is worth noting that even though the shading did not match the real cube, the lighting consistency is not totally lost the sense that darker and lighter areas are still the same as in the original image. 
